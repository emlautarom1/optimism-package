...

{
  ...
  "params": {
    ...
    "eip7702TransitionTimestamp": .config.isthmusTime|to_hex,
    "eip2537TransitionTimestamp": .config.isthmusTime|to_hex,
    "eip2935TransitionTimestamp": .config.isthmusTime|to_hex,
    "eip7623TransitionTimestamp": .config.isthmusTime|to_hex,
    "eip6110TransitionTimestamp": .config.isthmusTime|to_hex,
